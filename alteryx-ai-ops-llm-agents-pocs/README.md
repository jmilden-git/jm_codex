# Alteryx AI Ops LLM Agent POCs

[![Python](https://img.shields.io/badge/python-3.10%2B-blue.svg)](https://www.python.org/)
[![License](https://img.shields.io/badge/license-MIT-green.svg)](LICENSE)
[![CI](https://github.com/jmilden-git/alteryx-ai-ops-llm-agents-pocs/actions/workflows/ci.yml/badge.svg)](.github/workflows/ci.yml)
...
```bash
git clone https://github.com/jmilden-git/alteryx-ai-ops-llm-agents-pocs.git
cd alteryx-ai-ops-llm-agents-pocs
python -m venv .venv
