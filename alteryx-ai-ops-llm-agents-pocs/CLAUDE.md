...
**Alteryx AI Ops LLM Agents POCs** is a collection of three independent proof-of-concept AI agents demonstrating practical AI/ML capabilities for Go-To-Market (GTM) operations. Each agent showcases a different approach to solving marketing operations challenges using LLMs.
...
### Project Structure
```
alteryx-ai-ops-llm-agents-pocs/
